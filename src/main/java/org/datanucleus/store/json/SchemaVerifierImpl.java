...
/**
 * Implementation of a schema verifier for JSON.
 * This class provides a way for the JSON plugin to override any "default" handling that core provides to better fit in with the types
 * that are persistable in JSON.
 */
